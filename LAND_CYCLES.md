...
by how the wider Commander community values them — primarily **The Command Zone**
(mana-base philosophy: untapped, fetchable, flexible fixing wins) and
**MTGGoldfish's Commander Clash "Dual Land Tier List"** podcasts, cross-checked
against Flipside Gaming, Draftsim, and EDHREC land rankings.
...
- **Repo budget note:** several premium cycles (originals, fetches, some bonds/surveil/triomes)
  are **over €10** and therefore off-limits for the decks here — listed for completeness.
- Ordering reflects a *multiplayer, ~40-life* context. In 1v1 some conditional lands
  (bond lands especially) rank lower.

> **Source caveat:** MTGGoldfish's article pages 403 to automated fetches, so the
> tier placements below synthesize their podcast consensus plus the publicly
> readable community rankings cited under **Sources**. This is the consensus order,
> not a verbatim copy of any single list.
...
| **S** | Shock lands | Yes (2 life) | Excellent (2 basic types) | The premium workhorse dual |
...
| **B** | Pathway lands (MDFC) | Always | One color only | Consistency over flexibility |
| **C** | Scry lands (Temples) | Tapped | Good (scry 1) | ETB tapped is the whole cost |
| **C** | Tri-lands (wedge taplands) | Tapped | Excellent (3 colors) | Cheap 3-color tapland |
...
| **—** | Creature / man-lands | Varies | Utility, not fixing | Valued as threats/utility, not a mana-base staple |
...
### S — Fetch lands
`{T}, Pay 1 life, Sacrifice: Search for a land with a basic type.` Best fixing in the game — grab a shock/dual/basic, thin the deck, trigger landfall, fuel graveyard themes.
...
Command Zone caveat: only worth it if you actually run fetchable targets (shocks/duals/triomes); otherwise `Fabled Passage`/`Evolving Wilds` do the job cheaply.

### S — Shock lands
`As it enters, pay 2 life or it's tapped.` Two basic types → fetchable and check-land-enabling.
...
`Enters untapped if you have 2+ opponents.` = always untapped in multiplayer, no life cost.
| Land | Colors | EUR | Budget |
|------|--------|-----|--------|
...
### A — Triomes
`Tapped; three colors; two basic land types; cycling {3}.` Premier fixing for 3+ colors.
| Land | Colors | EUR | Budget |
|------|--------|-----|--------|
| Zagoth Triome | BUG | 18.12 | ⚠️ |

### A — Check lands (M10 / Innistrad)
`Enters tapped unless you control a land of the named basic type(s).`
| Land | Colors | EUR | Budget |
|------|--------|-----|--------|
...
### A — Pain lands
`{T}: Add {C}. {T}: Add A or B, deal 1 damage to you.` Always untapped; colorless mode is a bonus.
| Land | Colors | EUR | Budget |
|------|--------|-----|--------|
...
### A — Verge lands (Foundations, 2024+)
`{T}: Add A. {T}: Add B — only if you control a land of the right type.` Untapped, unlocks fast.
| Land | Colors | EUR | Budget |
|------|--------|-----|--------|
...
### A — Filter lands (Shadowmoor / Eventide)
`{T}: Add {C}. {A/B}, {T}: Add two mana in A/B.` Flexible double-color; need one colored input.
| Land | Colors | EUR | Budget |
|------|--------|-----|--------|
...
### B — Surveil lands (Murders at Karlov Manor)
`Enters tapped; surveil 1.` Two basic types (fetchable) + card selection.
| Land | Colors | EUR | Budget |
|------|--------|-----|--------|
...
### B — Horizon lands (Modern Horizons 1–2)
`{T}, Pay 1 life: Add A or B. {1}, {T}, Sacrifice: Draw a card.` Flood insurance.
| Land | Colors | EUR | Budget |
|------|--------|-----|--------|
...
Modal double-faced: pick one color when you play it; always untapped.
| Land | Colors | EUR | Budget |
|------|--------|-----|--------|
...
`Enters tapped; taps for any of three colors.`
| Land | Colors | EUR | Budget |
|------|--------|-----|--------|
...
### D — Bounce / Karoo lands (Ravnica "Guildgates" precursors, e.g. Dimir Aqueduct)
...
### — Creature / man-lands (utility, not core fixing)
Become creatures for a cost; valued as evasive threats / spot utility, not mana-base staples. Usually one color-pair, ETB varies.
| Land | Colors | EUR | Budget |
|------|--------|-----|--------|
...
## Sources
- [MTGGoldfish — Commander Clash Podcast: Dual Land Tier List (ep. 028)](https://www.mtggoldfish.com/articles/commander-clash-podcast-028-dual-land-tier-list)
- [MTGGoldfish — Commander Clash Podcast: Dual Land Tier List (ep. 249)](https://www.mtggoldfish.com/articles/commander-clash-podcast-249-dual-land-tier-list)
...
- [EDHREC — The Best MTG Lands of 2025 for Commander](https://edhrec.com/articles/the-best-mtg-lands-of-2025-for-commander)
- [MTGRocks — Top 5 Most Popular Land Cycles in Commander](https://mtgrocks.com/top-5-best-popular-land-cycles-in-commander/)
